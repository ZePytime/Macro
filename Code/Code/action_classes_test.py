...
from Code.Code.ui_action_frames.enums import MovementType
...
class KeyPress:
    ...
    def run_act(self):
        ...
        """
        print(f"KeyPress : {self.time_wait_s} | {self.keys} | {self.list_sp_keys}")
    ...
    def stop_press(self):
        ...
        print(f"KeyRelease : {self.keys} | {self.list_sp_keys}")
...
class ClickLeft:
    ...
    def run_act(self):
        ...
        print(f"ClickLeft : {self.pos_x} | {self.pos_y}")
...
class ClickRight:
    ...
    def run_act(self):
        ...
        print(f"ClickRight : {self.pos_x} | {self.pos_y}")
...
class Move:
    ...
    def run_act(self):
        ...
        if self.movement_type is MovementType.ABSOLUTE:
            print(f"Absolute : {self.pos_x} | {self.pos_y}")
        else:
            print(f"Relative : {self.pos_x} | {self.pos_y}")
...
class Write:
    ...
    def run_act(self):
        ...
        print(f"Write : {self.text_to_write}")
...
class Scroll:
    ...
    def run_act(self):
        ...
        print(f"Scroll : {self.direction} | {self.step}")
    ...
    def text(self):
        ...
        return f"Scroll : {self.direction} | {self.step}"
...
class Wait:
    ...
    def run_act(self):
        ...
        print(f"Wait : {self.time_wait_s}s")
        return self.time_wait_ms
...
class Loop:
    ...
    def run_act(self, advent_function=None, sleep_act_time=None):
        ...
        if self.ctr_of_turns < self.nb_turns:
            if self.ctr_of_turns == 0:
                print(f"Loop : {self.nb_turns} | {self.name}")
            else:
                print(f"Turns {self.name} n°{self.ctr_of_turns}")
            self.window.after(0, self.a_turn)
            self.ctr_of_turns += 1

        else:
            print(f"Fin of {self.name} Loop")
            self.ctr_of_turns = 0
...
class SameTime:
    ...
    def run_act(self, advent_function=None, sleep_act_time=None):
        ...
        if self.finich_running:
            print(f"SameTime : {self.list_sp_keys} | {self.keys} released")
            self.window.after(self.sleep_act_time, self.advent_function)
            self.finich_running = False
        else:
            print(f"SameTime : {self.list_sp_keys} | {self.keys} pressed")
