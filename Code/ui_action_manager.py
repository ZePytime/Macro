...
class ActionSelectorUI:
    ...
    """
    def __init__(self, window: tk.Tk, main_frm: tk.Frame, menu_btn_frame: tk.Frame, switch_frame: Callable[[tk.Frame], None], ui_action_tree: TreeUI) -> None:
        """
        ...
        self.selector_button = HoverButton(
            menu_btn_frame, 
            text="selector", 
        ...
        self.selector_button.grid(row=0, column=0, padx=2, pady=2)

        # Frame principale du menu
        # -------------------------
        # Main frame of the menu
        self.selector_frame = tk.Frame(main_frm, bg=W_VAR.NEUTRAL_800, width=340, height=460)
        ...
        self.selector_frame.rowconfigure(10, weight=1)
        ...
        click_frame = tk.Frame(self.selector_frame, bg=W_VAR.NEUTRAL_800)
        move_frame = tk.Frame(self.selector_frame, bg=W_VAR.NEUTRAL_800) 
        write_frame = tk.Frame(self.selector_frame, bg=W_VAR.NEUTRAL_800)
        scroll_frame = tk.Frame(self.selector_frame, bg=W_VAR.NEUTRAL_800)
        wait_frame = tk.Frame(self.selector_frame, bg=W_VAR.NEUTRAL_800)
        pressed_frame = tk.Frame(self.selector_frame, bg=W_VAR.NEUTRAL_800)
        parallel_actions_frame = tk.Frame(self.selector_frame, bg=W_VAR.NEUTRAL_800)
        loop_frame = tk.Frame(self.selector_frame, bg=W_VAR.NEUTRAL_800)
        ...
        self.radiobuttons_frame = tk.Frame(self.selector_frame, bg=W_VAR.NEUTRAL_800)
        self.radiobuttons_frame.grid(row=1, column=0)
        ...
        self.container_manager = ContainerManager(self.selector_frame)
        ...
        # for each action.
        self.click_ui = ClickFrame(click_frame)
        self.move_ui = MouseMoveFrame(move_frame)
        self.write_ui = WriteFrame(write_frame)
        self.scroll_ui = ScrollFrame(scroll_frame)
        self.wait_ui = WaitFrame(wait_frame)
        self.pressed_ui = KeyHoldFrame(pressed_frame)
        self.parallel_actions_ui = ParallelActionsFrame(parallel_actions_frame, self.container_manager)
        self.loop_ui = LoopFrame(loop_frame, self.container_manager)
