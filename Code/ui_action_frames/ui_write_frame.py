...
class WriteFrame:
    ...
    def __init__(self, parent_frame: tk.Frame):
        ...
        self.text_area = tk.Text(
            ...
            height=6, 
            width=26, 
            bg=W_VAR.BUTTON_1_HOVER, 
            font=W_VAR.font_size
            )
        self.text_area.grid(row=1, column=0, pady=(0, 5))
    ...
    def check(self) -> Union[bool, list[str]]:
        ...
        :return: False si le texte est invalide, 
            sinon une liste contenant le texte.
        -------------------------------------------------------------------
        Check that the entered text is valid.
        It must not be empty and must not exceed MAX_WRITE_LENGTH.

        :return: False if the text is invalid, 
            otherwise a list containing the text.
        """
