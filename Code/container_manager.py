...
class ContainerManager:
    ...
    def __init__(self, act_selector_frame: tk.Frame) -> None:
        """
        ...
        self._leave_container_frame=tk.Frame(act_selector_frame, bg=W_VAR.NEUTRAL_800)
        ...
        self._btn_leave_container = HoverButton(
            self._leave_container_frame, 
            text="leave", 
    ...
    def get_most_nested_container(self, action_dict: dict, current_key: int) -> Tuple[int, Action]:

        """
        Trouve le conteneur le plus imbriqué dans lequel on se trouve actuellement.
        
        :param action_dict: Dictionnaire des actions 
        :param dict_K: Clé du dictionnaire là où on se trouve actuellement.
        :returns: Tuple[int, Union[Action, int]] -
        ...
        :param action_dict: Dictionary of actions
        ...
        if container_entry > 1:
            nested_container_instance = action_dict[current_key-1]
            for i in range(container_entry-1):
                nested_container_instance = nested_container_instance.container_actions_dict[nested_container_instance.next_container_action_index-1]
            return container_entry, nested_container_instance
        else:
            return container_entry, action_dict[current_key-1]
