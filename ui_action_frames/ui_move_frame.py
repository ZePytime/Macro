...
class MouseMoveFrame:
    ...
    def __init__(self, parent_frame: tk.Frame, w_var: WindowVariable) -> None:
        ...
        frm_move_type = tk.Frame(parent_frame, bg=w_var.color_1)
    ...
    def check(self) -> Union[Tuple[int, int, MovementType], bool]:
        ...
        :return: un tuple (x, y, move_type) si ok, sinon False et affiche un message d'erreur.
        --------------------------------------------------------------------------------------
        Validate that entered coordinates are integers within screen bounds.
        
        :return: (x, y, move_type) on success, otherwise returns False and shows an inline error.
        """
