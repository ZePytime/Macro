...
class DocumentationUI:
    ...
    """
    def __init__(self, window: tk.Tk, menu_btn_frame: tk.Frame, switch_frame: Callable[[tk.Frame], None], w_var: WindowVariable) -> None:
        """
        ...
        self.doc_btn = tk.Button(menu_btn_frame, 
            text="doc", 
            bg=w_var.color_2, 
            fg="black", 
            height=1, 
        ...
        self.doc_btn.grid(row=0, column=3)
