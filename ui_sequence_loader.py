...
class SavedSequencesUI:
    ...
    """
    def __init__(self, window: tk.Tk, menu_btn_frame: tk.Frame, switch_frame: Callable[[tk.Frame], None], w_var: WindowVariable, reset_action_sequence: callable, action_dict_manager: ActionManager, leave_current_container: callable, container_manager: ContainerManager) -> None:
        """
        ...
        self.open_menu_btn.grid(row=0, column=2)
